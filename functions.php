 ...
 */
function brilliance_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'brilliance' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'brilliance' ),
...
add_action( 'widgets_init', 'brilliance_widgets_init' );
